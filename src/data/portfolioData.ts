...
export const PROJECTS: Project[] = [
  {
    ...
    imageCaption: 'Power BI Sales Insights & Profit Margin Executive Dashboard',
  ...
  },
  {
    ...
    imageCaption: 'BERT NLP Multi-Topic Real-Time Classification Neural Engine',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1531415074868-036b1c5f53ec?auto=format&fit=crop&w=900&q=80',
    imageCaption: 'T20 Cricket ESPNcricinfo Scraping & Squad Selection Dashboard',
    roleType: 'DATA_ANALYST',
    datasetStats: {
  ...
  },
  {
    ...
    imageCaption: 'Power BI Enterprise Attendance & Remote Work Utilization Dashboard',
    roleType: 'DATA_ANALYST',
    datasetStats: {
  ...
  },
  {
    ...
    imageCaption: 'Clinical NER Medical Prescription Entity Extraction & EHR Pipeline',
    roleType: 'DATA_SCIENTIST',
    datasetStats: {
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?auto=format&fit=crop&w=900&q=80',
    imageCaption: 'Supervised ML Customer Churn Classifier with SHAP Feature Attribution',
    roleType: 'DATA_SCIENTIST',
    datasetStats: {
  ...
  },
  {
    ...
    imageCaption: 'Credit Default Probability & Automated Underwriting Scorecard',
    roleType: 'DATA_SCIENTIST',
    datasetStats: {
  ...
  },
  {
    ...
    imageCaption: 'Multi-Cohort Retention Heatmap & CAC vs LTV Analytics Matrix',
    roleType: 'DATA_ANALYST',
    datasetStats: {
      rows: '320,000+ Orders',
  ...
  },
  {
    ...
    imageCaption: 'Sudan GIS Healthcare Facility Buffer Analysis & Spatial Deficit Map',
    roleType: 'BOTH',
    datasetStats: {
